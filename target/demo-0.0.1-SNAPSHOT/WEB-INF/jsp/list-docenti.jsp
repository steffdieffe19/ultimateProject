...
<div class="container my-4 content-wrapper">
    <h1 class="text-center my-4">Elenco Docenti</h1>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex flex-column flex-sm-row justify-content-center align-items-center gap-2">
                            <a class="btn btn-sm btn-success" href="<c:url value='/docenti/${d.id}/edit'/>">Modifica</a>
                            <form method="post" action="${pageContext.request.contextPath}/docenti/delete" class="d-inline">
